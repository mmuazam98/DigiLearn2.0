var data = [
  {
    ...
    description:
      "Lohri is a popular winter Punjabi folk festival, celebrated primarily by Hindus, Sikhs and Muslims from the Punjab region of the northern part of the Indian subcontinent, on 13 January of every year.",
  },
  {
    id: "Jan",
  ...
  },
  {
    ...
    description:
      'Holi is a popular ancient Hindu festival, also known as the Indian "festival of spring", the "festival of colours", or the "festival of love". The festival signifies the victory of good over evil.',
  },
  {
    id: "Mar",
  ...
  },
  {
    ...
    description:
      "Ram Navami, celebrated to commemorate the birth of Lord Rama, is a spring Hindu festival which marks the birth of Lord Rama, the seventh avatar of Lord Vishnu on the ninth day of Chaitra Navratri",
  },
  {
    id: "Apr",
    date: "6th April 2021",
    ...
    description:
      "Mahavir Janma Kalyanak is one of the most important religious festivals in Jainism. It celebrates the birth of Mahavir, the twenty-fourth and last Tirthankara of present Avasarpiṇi.",
  },
  {
    id: "Apr",
  ...
  },
  {
    ...
    description:
      "Ambedkar Jayanti or Bhim Jayanti is an annual festival observed on 14 April to commemorate the memory of B. R. Ambedkar, Indian polymath, the father of the Constitution of India and civil rights activist. It marks Dr. Babasaheb Ambedkar`s birthday who was born on 14 April 1891",
  },
  {
    id: "May",
    date: "7th May 2021",
  ...
  },
  {
    ...
    description:
      'Muslims celebrate this at Eid al-Adha. Eid al-Adha is called Id-ul-Adha in Arabic and Bakr-Id in the Indian subcontinent, because of the tradition of sacrificing a goat or "bakri" in Urdu. The word "id" derived from the Arabic "iwd" means "festival" and "zuha" comes from "uzhaiyya" which translates to "sacrifice".',
  },
  {
    id: "Aug",
  ...
  },
  {
    ...
    description:
      "Ganesh Chaturthi is celebrated annually to mark the birth of Lord Ganesha, the God of new beginnings and a fresh start. The festival falls in the month of Bhadra, according to the Hindu calendar and in August/September according to the Gregorian calendar.Aug",
  },
  {
    id: "Aug",
    ...
    description:
      "Muḥarram (Arabic: ٱلْمُحَرَّم‎) is the first month of the Islamic calendar. It is one of the four sacred months of the year when warfare is forbidden. It is held to be the second holiest month, after Ramaḍān. The Tenth day of Muharram is known as the Day of Ashura.",
  },
  {
    id: "Aug",
    ...
    description:
      "Onam is the official state festival of Kerala. It is celebrated with joy and enthusiasm all over the state by Malayalees regardless of religion, caste or creed. According to a popular legend, the festival is celebrated to welcome King Mahabali, whose spirit is said to visit Kerala at the time of Onam.",
  },
  {
    id: "Oct",
    ...
    description:
      "Honours Mahatma Gandhi`s role in Indian Independence. Community, historical celebrations. Gandhi Jayanti is an event celebrated in India to mark the birth anniversary of Mahatma Gandhi. It is celebrated annually on 2 October, and it is one of the three national holidays of India.",
  },
  {
    id: "Oct",
  ...
  },
  {
    ...
    description:
      "Diwali is the Hindu festival of lights, usually lasting five days and celebrated during the Hindu Lunisolar month Kartika. One of the most popular festivals of Hinduism.",
  },
  {
    id: "Nov",
    ...
    description:
      "Bhai Dooj, Bhaubeej, Bhai Tika, Bhai Phonta is a festival celebrated by Hindus on the second lunar day of Shukla Paksha in the Vikram Samvat Hindu calendar or of Shalivahan Shaka calendar month of Kartika.",
  },
  {
    id: "Nov",
...
// let date_ = new Date();
// let monName = monthNames[date_.getMonth()];
