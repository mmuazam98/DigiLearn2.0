  ...
  if (files.length != 0) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      var storageRef = firebase
        .storage()
        .ref(`C:\\Users\\91850\\Downloads\\${files[i].name}`);
    ...
    $.notify("Please choose atleast one file!", {
      position: "top left",
      className: "error",
    });
  }
...
document.getElementById("send2").addEventListener("click", function () {
  ...
  if (files2.length != 0) {
    ...
    for (let i = 0; i < files2.length; i++) {
      ...
      var storageRef = firebase
        .storage()
        .ref(`C:\\Users\\91850\\Downloads\\${files2[i].name}`);
      ...
      upload.on(
        ...
        function complete() {
          ...
          //     "uploading"
          //   ).innerHTML += `${files[i].name} upoaded <br />`;
          $.notify(files2[i].name + " uploaded successfully!", {
            position: "top left",
            className: "success",
          });
          setTimeout(function () {
...
document.getElementById("send3").addEventListener("click", function () {
  ...
  if (files3.length != 0) {
    ...
    for (let i = 0; i < files3.length; i++) {
      ...
      var storageRef = firebase
        .storage()
        .ref(`C:\\Users\\91850\\Downloads\\${files3[i].name}`);
      ...
      upload.on(
        ...
        function complete() {
          ...
          //     "uploading"
          //   ).innerHTML += `${files[i].name} upoaded <br />`;
          $.notify(files3[i].name + " uploaded successfully!", {
            position: "top left",
            className: "success",
          });
          setTimeout(function () {
...
document.getElementById("send4").addEventListener("click", function () {
  ...
  if (files4.length != 0) {
    ...
    for (let i = 0; i < files4.length; i++) {
      ...
      var storageRef = firebase
        .storage()
        .ref(`C:\\Users\\91850\\Downloads\\${files4[i].name}`);
      ...
      upload.on(
        ...
        function complete() {
          ...
          //     "uploading"
          //   ).innerHTML += `${files[i].name} upoaded <br />`;
          $.notify(files4[i].name + " uploaded successfully!", {
            position: "top left",
            className: "success",
          });
          setTimeout(function () {
...
document.getElementById("send5").addEventListener("click", function () {
  ...
  if (files5.length != 0) {
    ...
    for (let i = 0; i < files5.length; i++) {
      ...
      var storageRef = firebase
        .storage()
        .ref(`C:\\Users\\91850\\Downloads\\${files5[i].name}`);
      ...
      upload.on(
        ...
        function complete() {
          ...
          //     "uploading"
          //   ).innerHTML += `${files[i].name} upoaded <br />`;
          $.notify(files5[i].name + " uploaded successfully!", {
            position: "top left",
            className: "success",
          });
          setTimeout(function () {
...
document.getElementById("send6").addEventListener("click", function () {
  ...
  if (files6.length != 0) {
    ...
    for (let i = 0; i < files6.length; i++) {
      ...
      var storageRef = firebase
        .storage()
        .ref(`C:\\Users\\91850\\Downloads\\${files6[i].name}`);
      ...
      upload.on(
        ...
        function complete() {
          ...
          //     "uploading"
          //   ).innerHTML += `${files[i].name} upoaded <br />`;
          $.notify(files6[i].name + " uploaded successfully!", {
            position: "top left",
            className: "success",
          });
          setTimeout(function () {
